...
\fi 
    ...
    \chapter*{版权}
       \subfile{src/zh-cn/copyright}    

    \chapter*{致谢}
      \addcontentsline{toc}{chapter}{Acknowledgments}
      \subfile{src/zh-cn/acknowledgment}

    \chapter*{如何提交反馈}
      \subfile{src/zh-cn/erratas}
  

    \chapter*{John Carmack 序}
      \addcontentsline{toc}{chapter}{John Carmack 序}
      \subfile{src/zh-cn/foreword}

    \chapter*{Dave Taylor 序}
      \addcontentsline{toc}{chapter}{Dave Taylor 序}
      \subfile{src/zh-cn/foreword_ddt.tex}

    \chapter*{John Romero 序}
      \addcontentsline{toc}{chapter}{John Romero 序}
      \subfile{src/zh-cn/foreword_romero.tex}
    ...
    \pagebreak
     ...
     \chapter*{前言}
       ...
       \subfile{src/zh-cn/preface}
    

    \chapter{引言}
      \subfile{src/zh-cn/introduction}

   
      \chapter{IBM PC}
        \subfile{src/zh-cn/environment}
        \subfile{src/zh-cn/486}
        \subfile{src/zh-cn/vga}
        \subfile{src/zh-cn/sound}
        \subfile{src/zh-cn/network}
        \subfile{src/zh-cn/dos_extender}
        \subfile{src/zh-cn/watcom}    
     ...
     \chapter{NeXT}
       \subfile{src/zh-cn/next}   


    

    \chapter{团队与工具}
      \subfile{src/zh-cn/team} 
      \subfile{src/zh-cn/team_sprites} 
      \subfile{src/zh-cn/team_maps} 
      \subfile{src/zh-cn/team_finger}
      \subfile{src/zh-cn/team_audio}
      \subfile{src/zh-cn/team_programming}
      \subfile{src/zh-cn/team_distribution}
      \subfile{src/zh-cn/team_pipeline}




     \chapter{软件：idTech 1}
      \subfile{src/zh-cn/software}
      \subfile{src/zh-cn/software_arch}
      \subfile{src/zh-cn/software_mem}
      \subfile{src/zh-cn/software_wad}
       \subfile{src/zh-cn/software_video}
       \subfile{src/zh-cn/software_renderers}
       \subfile{src/zh-cn/software_2drenderer}
       \subfile{src/zh-cn/software_3drenderer}
       \subfile{src/zh-cn/software_palette_effects}
       \subfile{src/zh-cn/software_input}
       \subfile{src/zh-cn/software_audio}
       \subfile{src/zh-cn/software_collisions}
       \subfile{src/zh-cn/software_ia}   
        \subfile{src/zh-cn/software_net}
      \subfile{src/zh-cn/software_performances}

    \chapter{家用机移植}        
      \subfile{src/zh-cn/ports}    

    \chapter*{尾声}
      \addcontentsline{toc}{chapter}{尾声}
      \subfile{src/zh-cn/epilogue}

    \appendix
    \appendixpage
      \chapter{缺陷}
      \subfile{src/zh-cn/bugs}
    \chapter{点阵}  
      \subfile{src/zh-cn/dots}


    \chapter{NeXTstation TurboColor}
    \subfile{src/zh-cn/map_benchmark}
    
      \chapter{新闻稿}
      \subfile{src/zh-cn/press_release}
      \chapter{源代码发布说明}
      \subfile{src/zh-cn/release_notes}
      \chapter{doombsp 发布说明}
      \subfile{src/zh-cn/release_notes_doombsp}
      \chapter{幸存者的策略与秘密}
      \subfile{src/zh-cn/essays}
   
      \chapter{与 Dave Taylor 的访谈}
      \subfile{src/zh-cn/dave_interview}
      \chapter{与 Randy Linden 的访谈}
      \subfile{src/zh-cn/randy_interview}      
      \chapter{OpenGL 与 Direct3D .plan}
      \subfile{src/zh-cn/openglvsdirect3d}

        \chapter{黑皮书内部细节}
    \subfile{src/zh-cn/internals}
